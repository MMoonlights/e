...
local RARITY_INFO = {
    ...
    [3] = { name = "Epic" },
    [4] = { name = "Legendary" },
    [5] = { name = "Mythical" }, -- ДОБАВЛЕН МИФИЧЕСКИЙ РАНГ
}
...
local carRarityCache = {
    ...
    ["Artho VS600"] = 3, ["Artho X723"] = 1, ["Bantt Rental"] = 0, ["Beressa Char"] = 5, -- Mythical
    ["Beressa Verona"] = 5, -- Mythical
    ...
    ["Ivar Manguster"] = 0, ["Konsegga Artero"] = 5, -- Mythical
    ...
    ["Mazuta JO4"] = 2, ["Mazuta Mint"] = 1, ["Medallia 84F"] = 4, ["Medallia B44"] = 5, -- Mythical
    ["Mitta Aydens REO"] = 2, ["MoLesennen 270N"] = 4, -- Исправлено на Легендарный (4)
    ["Nikken 290S"] = 2, ["Nikken Altimata"] = 0, ["Nikken Sinata B21"] = 2,
    ["Nikken Starline S340"] = 3, ["Nikken Starline S350"] = 3, ["Preischel 311 SR3 GTK"] = 4, -- Исправлено на Легендарный (4)
...
local function findNewestCarIndex()
    ...
    local garageGui = rg:FindFirstChild("Guis") and rg.Guis:FindFirst
